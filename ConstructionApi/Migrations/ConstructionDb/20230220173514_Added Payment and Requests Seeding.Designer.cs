...
namespace ConstructionApi.Migrations.ConstructionDb
{
    ...
    [Migration("20230220173514_Added Payment and Requests Seeding")]
    partial class AddedPaymentandRequestsSeeding
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ConstructionApi.Models.Client", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ClientID = 1L,
                            AddedBy = "",
                            AddedOn = new DateTime(2023, 2, 20, 17, 35, 13, 813, DateTimeKind.Utc).AddTicks(2986),
                            ChangedBy = "",
                            ChangedOn = new DateTime(2023, 2, 20, 17, 35, 13, 813, DateTimeKind.Utc).AddTicks(2989),
                        ...
                        new
                        {
                            ClientID = 2L,
                            AddedBy = "",
                            AddedOn = new DateTime(2023, 2, 20, 17, 35, 13, 813, DateTimeKind.Utc).AddTicks(4453),
                            ChangedBy = "",
                            ChangedOn = new DateTime(2023, 2, 20, 17, 35, 13, 813, DateTimeKind.Utc).AddTicks(4453),
            ...
            modelBuilder.Entity("ConstructionApi.Models.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            CompanyID = 1L,
                            AddedBy = "",
                            AddedOn = new DateTime(2023, 2, 20, 17, 35, 13, 813, DateTimeKind.Utc).AddTicks(4793),
                            Address = "123 Main Street",
                            ChangedBy = "",
                            ChangedOn = new DateTime(2023, 2, 20, 17, 35, 13, 813, DateTimeKind.Utc).AddTicks(4793),
                        ...
                        new
                        {
                            CompanyID = 2L,
                            AddedBy = "",
                            AddedOn = new DateTime(2023, 2, 20, 17, 35, 13, 813, DateTimeKind.Utc).AddTicks(5956),
                            Address = "456 Maple Avenue",
                            ChangedBy = "",
                            ChangedOn = new DateTime(2023, 2, 20, 17, 35, 13, 813, DateTimeKind.Utc).AddTicks(5956),
            ...
            modelBuilder.Entity("ConstructionApi.Models.ConstructionRequest", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AddedBy = "",
                            AddedOn = new DateTime(2023, 2, 20, 17, 35, 13, 814, DateTimeKind.Utc).AddTicks(750),
                            ChangedBy = "",
                            ChangedOn = new DateTime(2023, 2, 20, 17, 35, 13, 814, DateTimeKind.Utc).AddTicks(751),
                            ClientID = 1L,
                            CompanyID = 1L,
                            Description = "First Request Description",
                            EntityStatus = 1,
                            EstimatedEndDate = new DateTime(2025, 2, 20, 17, 35, 13, 814, DateTimeKind.Utc).AddTicks(1678),
                            PaymentID = 1L,
                            ProjectID = 1L,
                            Remarks = "First Request Remarks",
                            StartDate = new DateTime(2023, 2, 20, 17, 35, 13, 814, DateTimeKind.Utc).AddTicks(1425),
                            StatusID = 2L
                        });
                });
            ...
            modelBuilder.Entity("ConstructionApi.Models.Payment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PaymentID = 1L,
                            AddedBy = "",
                            AddedOn = new DateTime(2023, 2, 20, 17, 35, 13, 813, DateTimeKind.Utc).AddTicks(9472),
                            Amount = 250000000.0,
                            ChangedBy = "",
                            ChangedOn = new DateTime(2023, 2, 20, 17, 35, 13, 813, DateTimeKind.Utc).AddTicks(9472),
                            EntityStatus = 1,
                            OrderID = "9c85143b-e7c9-498e-9853-a498b7a5f918",
                            Status = 0
                        });
                });
            ...
            modelBuilder.Entity("ConstructionApi.Models.Project", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ProjectID = 1L,
                            AddedBy = "",
                            AddedOn = new DateTime(2023, 2, 20, 17, 35, 13, 813, DateTimeKind.Utc).AddTicks(7545),
                            Address = "123 Al Khan Street",
                            ChangedBy = "",
                            ChangedOn = new DateTime(2023, 2, 20, 17, 35, 13, 813, DateTimeKind.Utc).AddTicks(7545),
                        ...
                        new
                        {
                            ProjectID = 2L,
                            AddedBy = "",
                            AddedOn = new DateTime(2023, 2, 20, 17, 35, 13, 813, DateTimeKind.Utc).AddTicks(9245),
                            Address = "123 Al Emarat Street",
                            ChangedBy = "",
                            ChangedOn = new DateTime(2023, 2, 20, 17, 35, 13, 813, DateTimeKind.Utc).AddTicks(9245),
