...
namespace ConstructionApi.Migrations.ConstructionDb
{
    ...
    [Migration("20230220191923_updated request model (payment nullable)")]
    partial class updatedrequestmodelpaymentnullable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ConstructionApi.Models.Client", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ClientID = 1L,
                            AddedBy = "",
                            AddedOn = new DateTime(2023, 2, 20, 19, 19, 22, 669, DateTimeKind.Utc).AddTicks(994),
                            ChangedBy = "",
                            ChangedOn = new DateTime(2023, 2, 20, 19, 19, 22, 669, DateTimeKind.Utc).AddTicks(1008),
                        ...
                        new
                        {
                            ClientID = 2L,
                            AddedBy = "",
                            AddedOn = new DateTime(2023, 2, 20, 19, 19, 22, 669, DateTimeKind.Utc).AddTicks(2336),
                            ChangedBy = "",
                            ChangedOn = new DateTime(2023, 2, 20, 19, 19, 22, 669, DateTimeKind.Utc).AddTicks(2337),
            ...
            modelBuilder.Entity("ConstructionApi.Models.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            CompanyID = 1L,
                            AddedBy = "",
                            AddedOn = new DateTime(2023, 2, 20, 19, 19, 22, 669, DateTimeKind.Utc).AddTicks(2587),
                            Address = "123 Main Street",
                            ChangedBy = "",
                            ChangedOn = new DateTime(2023, 2, 20, 19, 19, 22, 669, DateTimeKind.Utc).AddTicks(2587),
                        ...
                        new
                        {
                            CompanyID = 2L,
                            AddedBy = "",
                            AddedOn = new DateTime(2023, 2, 20, 19, 19, 22, 669, DateTimeKind.Utc).AddTicks(3718),
                            Address = "456 Maple Avenue",
                            ChangedBy = "",
                            ChangedOn = new DateTime(2023, 2, 20, 19, 19, 22, 669, DateTimeKind.Utc).AddTicks(3718),
            ...
            modelBuilder.Entity("ConstructionApi.Models.ConstructionRequest", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AddedBy = "TestClient1",
                            AddedOn = new DateTime(2023, 2, 20, 19, 19, 22, 669, DateTimeKind.Utc).AddTicks(8728),
                            ChangedBy = "",
                            ChangedOn = new DateTime(2023, 2, 20, 19, 19, 22, 669, DateTimeKind.Utc).AddTicks(8728),
                            ClientID = 1L,
                            CompanyID = 1L,
                            Description = "First Request Description",
                            EntityStatus = 1,
                            EstimatedEndDate = new DateTime(2025, 2, 20, 19, 19, 22, 669, DateTimeKind.Utc).AddTicks(9729),
                            PaymentID = 1L,
                            ProjectID = 1L,
                            Remarks = "First Request Remarks",
                            StartDate = new DateTime(2023, 2, 20, 19, 19, 22, 669, DateTimeKind.Utc).AddTicks(9373),
                            StatusID = 2L
                        });
                });
            ...
            modelBuilder.Entity("ConstructionApi.Models.Payment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PaymentID = 1L,
                            AddedBy = "",
                            AddedOn = new DateTime(2023, 2, 20, 19, 19, 22, 669, DateTimeKind.Utc).AddTicks(7245),
                            Amount = 250000000.0,
                            ChangedBy = "",
                            ChangedOn = new DateTime(2023, 2, 20, 19, 19, 22, 669, DateTimeKind.Utc).AddTicks(7245),
                            EntityStatus = 1,
                            OrderID = "c8a5130b-17c0-424f-908d-226be56ff193",
                            Status = 0
                        });
                });
            ...
            modelBuilder.Entity("ConstructionApi.Models.Project", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ProjectID = 1L,
                            AddedBy = "",
                            AddedOn = new DateTime(2023, 2, 20, 19, 19, 22, 669, DateTimeKind.Utc).AddTicks(5331),
                            Address = "123 Al Khan Street",
                            ChangedBy = "",
                            ChangedOn = new DateTime(2023, 2, 20, 19, 19, 22, 669, DateTimeKind.Utc).AddTicks(5332),
                        ...
                        new
                        {
                            ProjectID = 2L,
                            AddedBy = "",
                            AddedOn = new DateTime(2023, 2, 20, 19, 19, 22, 669, DateTimeKind.Utc).AddTicks(7024),
                            Address = "123 Al Emarat Street",
                            ChangedBy = "",
                            ChangedOn = new DateTime(2023, 2, 20, 19, 19, 22, 669, DateTimeKind.Utc).AddTicks(7025),
