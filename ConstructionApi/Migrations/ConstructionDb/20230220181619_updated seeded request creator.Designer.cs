...
namespace ConstructionApi.Migrations.ConstructionDb
{
    ...
    [Migration("20230220181619_updated seeded request creator")]
    partial class updatedseededrequestcreator
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ConstructionApi.Models.Client", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ClientID = 1L,
                            AddedBy = "",
                            AddedOn = new DateTime(2023, 2, 20, 18, 16, 19, 30, DateTimeKind.Utc).AddTicks(8170),
                            ChangedBy = "",
                            ChangedOn = new DateTime(2023, 2, 20, 18, 16, 19, 30, DateTimeKind.Utc).AddTicks(8174),
                        ...
                        new
                        {
                            ClientID = 2L,
                            AddedBy = "",
                            AddedOn = new DateTime(2023, 2, 20, 18, 16, 19, 30, DateTimeKind.Utc).AddTicks(9611),
                            ChangedBy = "",
                            ChangedOn = new DateTime(2023, 2, 20, 18, 16, 19, 30, DateTimeKind.Utc).AddTicks(9612),
            ...
            modelBuilder.Entity("ConstructionApi.Models.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            CompanyID = 1L,
                            AddedBy = "",
                            AddedOn = new DateTime(2023, 2, 20, 18, 16, 19, 30, DateTimeKind.Utc).AddTicks(9920),
                            Address = "123 Main Street",
                            ChangedBy = "",
                            ChangedOn = new DateTime(2023, 2, 20, 18, 16, 19, 30, DateTimeKind.Utc).AddTicks(9921),
                        ...
                        new
                        {
                            CompanyID = 2L,
                            AddedBy = "",
                            AddedOn = new DateTime(2023, 2, 20, 18, 16, 19, 31, DateTimeKind.Utc).AddTicks(1085),
                            Address = "456 Maple Avenue",
                            ChangedBy = "",
                            ChangedOn = new DateTime(2023, 2, 20, 18, 16, 19, 31, DateTimeKind.Utc).AddTicks(1085),
            ...
            modelBuilder.Entity("ConstructionApi.Models.ConstructionRequest", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AddedBy = "TestClient1",
                            AddedOn = new DateTime(2023, 2, 20, 18, 16, 19, 31, DateTimeKind.Utc).AddTicks(5964),
                            ChangedBy = "",
                            ChangedOn = new DateTime(2023, 2, 20, 18, 16, 19, 31, DateTimeKind.Utc).AddTicks(5965),
                            ClientID = 1L,
                            CompanyID = 1L,
                            Description = "First Request Description",
                            EntityStatus = 1,
                            EstimatedEndDate = new DateTime(2025, 2, 20, 18, 16, 19, 31, DateTimeKind.Utc).AddTicks(6899),
                            PaymentID = 1L,
                            ProjectID = 1L,
                            Remarks = "First Request Remarks",
                            StartDate = new DateTime(2023, 2, 20, 18, 16, 19, 31, DateTimeKind.Utc).AddTicks(6644),
                            StatusID = 2L
                        });
                });
            ...
            modelBuilder.Entity("ConstructionApi.Models.Payment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PaymentID = 1L,
                            AddedBy = "",
                            AddedOn = new DateTime(2023, 2, 20, 18, 16, 19, 31, DateTimeKind.Utc).AddTicks(4631),
                            Amount = 250000000.0,
                            ChangedBy = "",
                            ChangedOn = new DateTime(2023, 2, 20, 18, 16, 19, 31, DateTimeKind.Utc).AddTicks(4632),
                            EntityStatus = 1,
                            OrderID = "8f3183ae-1385-4a73-b86b-9dcbdbb4860d",
                            Status = 0
                        });
                });
            ...
            modelBuilder.Entity("ConstructionApi.Models.Project", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ProjectID = 1L,
                            AddedBy = "",
                            AddedOn = new DateTime(2023, 2, 20, 18, 16, 19, 31, DateTimeKind.Utc).AddTicks(2687),
                            Address = "123 Al Khan Street",
                            ChangedBy = "",
                            ChangedOn = new DateTime(2023, 2, 20, 18, 16, 19, 31, DateTimeKind.Utc).AddTicks(2687),
                        ...
                        new
                        {
                            ProjectID = 2L,
                            AddedBy = "",
                            AddedOn = new DateTime(2023, 2, 20, 18, 16, 19, 31, DateTimeKind.Utc).AddTicks(4401),
                            Address = "123 Al Emarat Street",
                            ChangedBy = "",
                            ChangedOn = new DateTime(2023, 2, 20, 18, 16, 19, 31, DateTimeKind.Utc).AddTicks(4401),
