...
namespace ConstructionApi.Migrations.ConstructionDb
{
    ...
    [Migration("20230220154305_Initial")]
            ...
            modelBuilder.Entity("ConstructionApi.Models.Client", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ClientID = 1L,
                            AddedBy = "",
                            AddedOn = new DateTime(2023, 2, 20, 15, 43, 5, 500, DateTimeKind.Utc).AddTicks(5604),
                            ChangedBy = "",
                            ChangedOn = new DateTime(2023, 2, 20, 15, 43, 5, 500, DateTimeKind.Utc).AddTicks(5608),
                        ...
                        new
                        {
                            ClientID = 2L,
                            AddedBy = "",
                            AddedOn = new DateTime(2023, 2, 20, 15, 43, 5, 500, DateTimeKind.Utc).AddTicks(7941),
                            ChangedBy = "",
                            ChangedOn = new DateTime(2023, 2, 20, 15, 43, 5, 500, DateTimeKind.Utc).AddTicks(7942),
            ...
            modelBuilder.Entity("ConstructionApi.Models.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            CompanyID = 1L,
                            AddedBy = "",
                            AddedOn = new DateTime(2023, 2, 20, 15, 43, 5, 500, DateTimeKind.Utc).AddTicks(8378),
                            Address = "123 Main Street",
                            ChangedBy = "",
                            ChangedOn = new DateTime(2023, 2, 20, 15, 43, 5, 500, DateTimeKind.Utc).AddTicks(8379),
                        ...
                        new
                        {
                            CompanyID = 2L,
                            AddedBy = "",
                            AddedOn = new DateTime(2023, 2, 20, 15, 43, 5, 501, DateTimeKind.Utc).AddTicks(416),
                            Address = "456 Maple Avenue",
                            ChangedBy = "",
                            ChangedOn = new DateTime(2023, 2, 20, 15, 43, 5, 501, DateTimeKind.Utc).AddTicks(416),
            ...
            modelBuilder.Entity("ConstructionApi.Models.Project", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ProjectID = 1L,
                            AddedBy = "",
                            AddedOn = new DateTime(2023, 2, 20, 15, 43, 5, 501, DateTimeKind.Utc).AddTicks(3466),
                            Address = "123 Al Khan Street",
                            ChangedBy = "",
                            ChangedOn = new DateTime(2023, 2, 20, 15, 43, 5, 501, DateTimeKind.Utc).AddTicks(3467),
                        ...
                        new
                        {
                            ProjectID = 2L,
                            AddedBy = "",
                            AddedOn = new DateTime(2023, 2, 20, 15, 43, 5, 501, DateTimeKind.Utc).AddTicks(6451),
                            Address = "123 Al Emarat Street",
                            ChangedBy = "",
                            ChangedOn = new DateTime(2023, 2, 20, 15, 43, 5, 501, DateTimeKind.Utc).AddTicks(6452),
