...
namespace ConstructionApi.Migrations.ConstructionDb
{
    ...
    [Migration("20230220184717_updated request model (startdate, enddate)")]
    partial class updatedrequestmodelstartdateenddate
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ConstructionApi.Models.Client", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ClientID = 1L,
                            AddedBy = "",
                            AddedOn = new DateTime(2023, 2, 20, 18, 47, 17, 224, DateTimeKind.Utc).AddTicks(6852),
                            ChangedBy = "",
                            ChangedOn = new DateTime(2023, 2, 20, 18, 47, 17, 224, DateTimeKind.Utc).AddTicks(6855),
                        ...
                        new
                        {
                            ClientID = 2L,
                            AddedBy = "",
                            AddedOn = new DateTime(2023, 2, 20, 18, 47, 17, 224, DateTimeKind.Utc).AddTicks(8556),
                            ChangedBy = "",
                            ChangedOn = new DateTime(2023, 2, 20, 18, 47, 17, 224, DateTimeKind.Utc).AddTicks(8557),
            ...
            modelBuilder.Entity("ConstructionApi.Models.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            CompanyID = 1L,
                            AddedBy = "",
                            AddedOn = new DateTime(2023, 2, 20, 18, 47, 17, 224, DateTimeKind.Utc).AddTicks(8824),
                            Address = "123 Main Street",
                            ChangedBy = "",
                            ChangedOn = new DateTime(2023, 2, 20, 18, 47, 17, 224, DateTimeKind.Utc).AddTicks(8825),
                        ...
                        new
                        {
                            CompanyID = 2L,
                            AddedBy = "",
                            AddedOn = new DateTime(2023, 2, 20, 18, 47, 17, 225, DateTimeKind.Utc).AddTicks(219),
                            Address = "456 Maple Avenue",
                            ChangedBy = "",
                            ChangedOn = new DateTime(2023, 2, 20, 18, 47, 17, 225, DateTimeKind.Utc).AddTicks(220),
            ...
            modelBuilder.Entity("ConstructionApi.Models.ConstructionRequest", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ConstructionRequestID = 1L,
                            AddedBy = "TestClient1",
                            AddedOn = new DateTime(2023, 2, 20, 18, 47, 17, 225, DateTimeKind.Utc).AddTicks(5879),
                            ChangedBy = "",
                            ChangedOn = new DateTime(2023, 2, 20, 18, 47, 17, 225, DateTimeKind.Utc).AddTicks(5880),
                            ClientID = 1L,
                            CompanyID = 1L,
                            Description = "First Request Description",
                            EntityStatus = 1,
                            EstimatedEndDate = new DateTime(2025, 2, 20, 18, 47, 17, 225, DateTimeKind.Utc).AddTicks(7117),
                            PaymentID = 1L,
                            ProjectID = 1L,
                            Remarks = "First Request Remarks",
                            StartDate = new DateTime(2023, 2, 20, 18, 47, 17, 225, DateTimeKind.Utc).AddTicks(6697),
                            StatusID = 2L
                        });
                });
            ...
            modelBuilder.Entity("ConstructionApi.Models.Payment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PaymentID = 1L,
                            AddedBy = "",
                            AddedOn = new DateTime(2023, 2, 20, 18, 47, 17, 225, DateTimeKind.Utc).AddTicks(4388),
                            Amount = 250000000.0,
                            ChangedBy = "",
                            ChangedOn = new DateTime(2023, 2, 20, 18, 47, 17, 225, DateTimeKind.Utc).AddTicks(4388),
                            EntityStatus = 1,
                            OrderID = "24d8e199-b06a-4a68-acc7-bf7faf6a8212",
                            Status = 0
                        });
                });
            ...
            modelBuilder.Entity("ConstructionApi.Models.Project", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ProjectID = 1L,
                            AddedBy = "",
                            AddedOn = new DateTime(2023, 2, 20, 18, 47, 17, 225, DateTimeKind.Utc).AddTicks(2034),
                            Address = "123 Al Khan Street",
                            ChangedBy = "",
                            ChangedOn = new DateTime(2023, 2, 20, 18, 47, 17, 225, DateTimeKind.Utc).AddTicks(2035),
                        ...
                        new
                        {
                            ProjectID = 2L,
                            AddedBy = "",
                            AddedOn = new DateTime(2023, 2, 20, 18, 47, 17, 225, DateTimeKind.Utc).AddTicks(4144),
                            Address = "123 Al Emarat Street",
                            ChangedBy = "",
                            ChangedOn = new DateTime(2023, 2, 20, 18, 47, 17, 225, DateTimeKind.Utc).AddTicks(4145),
